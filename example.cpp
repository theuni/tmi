...
int main()
{
    tmi::multi_index_container<myclass,tmi::indexed_by<tmi::hashed_unique<tmi::tag<hash_unique>, hash_myclass_unique, hash_myclass_unique, hash_myclass_unique>,
                     ...
                     std::allocator<myclass>> bar{std::make_tuple(std::make_tuple(32UL, hash_myclass_unique(), hash_myclass_unique(), hash_myclass_unique()), std::make_tuple(tmi::identity<myclass>(), compare_myclass_less()), std::make_tuple(tmi::identity<myclass>(), compare_myclass_greater()))};
